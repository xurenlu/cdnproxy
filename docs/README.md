...
假设您的 CDNProxy 服务部署在 `https://proxy.example.com`。

**原始 URL:**
`https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css`

**通过代理访问:**
`https://proxy.example.com/cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css`

**原始 URL:**
`https://unpkg.com/react@18/umd/react.development.js`

**通过代理访问:**
`https://proxy.example.com/unpkg.com/react@18/umd/react.development.js`

您只需将需要代理的 CDN URL 中的 `https://` 替换为您的代理服务地址即可。
