...
```bash
# 代理视频文件
curl "https://cdnproxy.shifen.de/cdn.jsdelivr.net/npm/video.js@8.6.1/dist/video.min.js"

# 检查缓存头
curl -I "https://cdnproxy.shifen.de/cdn.jsdelivr.net/npm/video.js@8.6.1/dist/video.min.js"
...
```bash
# 代理音频文件
curl "https://cdnproxy.shifen.de/cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.1/svgs/solid/music.svg"

# 检查缓存头
curl -I "https://cdnproxy.shifen.de/cdn.jsdelivr.net/npm/@fortawesome/fontawesome-free@6.5.1/svgs/solid/music.svg"
# 返回: Cache-Control: public, max-age=604800
```
...
curl -H "Range: bytes=0-1023" "https://cdnproxy.shifen.de/example.com/video.mp4"
```
